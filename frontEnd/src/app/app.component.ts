...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet,HeaderComponent,FooterComponent,FormSearchComponent,CommonModule,PropertyListComponent,PaginatorModule,PropertyDetailComponent,ConnexionComponent],
  templateUrl: './app.component.html',
  styleUrl: './app.component.scss'
})
export class AppComponent {
  title = 'frontEnd';
  constructor (private router :Router,private biensService :BiensServiceService){}
  biens: Bien[] = [];
